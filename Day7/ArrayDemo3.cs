...
namespace ConsoleDemoApp.Day7
{
    internal class ArrayDemo3
    {
        static void Main(string[] args)
        {
            ...
            // Array matrix = Array.CreateInstance(typeof(string), 5, 4); //no need of sub string

            //cities[0] = "patna";//invalid indexinf form cant be read or write
            //Console.WriteLine(cities[2]);//invalid
            // for assigning value using Setvalue() method
            ...
            //Array newcity = cities;// deep copy
